...
export const DEFAULT_COGS = [
  'FOOD INGREDIENTS', 'INGREDIENT FOR FOOD', 'INGREDIENTS FOR FOOD', 'INGREDIENTS 4 FOOD', 'INGREDIENT 4 FOOD',
...
export const DEFAULT_LABOUR = [
  'EMPLOYEE - STAFF MEALS', 'STAFF MEALS', 'SALARY', 'SALARIES', 'STAFF SALARY', 'STAFF SALARIES', 'EMPLOYEE SALARY',
  'LABOUR', 'WAGES', 'PAYROLL', 'STAFF PAYROLL', 'STAFF INCENTIVES', 'INCENTIVES', 'EMPLOYEES', 'EMPLOYEE ADVANCE', 'BONUS'
];

export const DEFAULT_OPS = [
  'MARKETING', 'UTILITIES', 'MAINTENANCE', 'REPAIRS', 'CLEANING', 'SOFTWARE', 'INTERNET', 'STATIONERY', 'TRAVEL',
  'MISC', 'ELECTRICITY', 'WATER', 'TRANSPORTATION & TRAVEL EXPENSE', 'PRINTING AND STATIONERY', 'RENT', 'OFFICE'
];
